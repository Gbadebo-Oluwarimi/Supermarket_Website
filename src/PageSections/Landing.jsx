    ...
    <div>
      ...
      <div className='landing bg-slate-400 w-full'>
         <div className=' gap-x-11  m-auto max-w-7xl md:flex p-3 pt-4 inline-block w-full'>
            <div className='w-full  background flex rounded-md md:w-8/12 h-96 bg-slate-200 p-0 overflow-hidden'>
            ...
            <div className='w-full mt-10 md:mt-0 rounded-md md:w-1/3 h-96 bg-yellow-300 p-1 overflow-hidden '>
