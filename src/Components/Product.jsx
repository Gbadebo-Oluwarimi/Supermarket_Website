       ...
       <div className='inline-block items-center align-middle bg-gray-50 p-2 rounded-lg mb-2'>
            ...
            <div className='flex justify-between items-center m-3'>
               ...
               <div className='font-bold text-sm'>{price}</div>
                ...
                <div><button onClick={() => updatestate(id)} className='transition ease-out duration-200  border-gray-50 border-2 focus:ring-2 focus:ring-yellow-300  text-sm m-1 bg-yellow-500 mt-1 p-2 rounded-md text-slate-50'>Add to Cart</button></div>
        </div>
